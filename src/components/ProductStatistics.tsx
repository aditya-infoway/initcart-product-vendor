...
const ProductStatistics: FC<Props> = ({
  className = "",
  chartColor,
  chartHeight,
}) => {
  ...
  return (
    <div
      className={`rounded-2xl shadow-md bg-white dark:bg-gray-800 ${className}`}
    >
      {/* Header */}
...
const chartOptions = (
  ...
  const baseColor =
    getCSSVariableValue("--tw-color-" + chartColor) || "#4f46e5";
